    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <asp:TextBox ID="addtask" runat="server" placeholder="Task Name" CssClass="form-control"></asp:TextBox>
                <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" OnClick="AddTask_Click" Text="Add Task" />
